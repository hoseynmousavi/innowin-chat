...
app.route("/sendMessage")
    .post((req, res) =>
    {
        ...
        {
            arr[receiver].token && webpush.sendNotification(arr[receiver].token, JSON.stringify({title: "پیام رسان اینوین", body: data.text, icon: 'https://innowin.ir/icon-192x192.png'})).catch(err => console.error(err))
